...
public class ExamScheduler {
    ...
    public void test() throws IOException, InterruptedException {
        ...
        for(Intranet user : intranets){
            ...
            ExamTable examTable = examScraping.scraping(loginMember.getIntCookie());
            ExamForm examForm = examScraping.convert(loginMember.getSid(), examTable);//key : 시험이름, value : 통과여부
